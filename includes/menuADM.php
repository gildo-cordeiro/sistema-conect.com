<nav class="navbar navbar-transparent navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="perfil.php" class="navbar-brand hidden-xs hidden-sm" title="Inicial">
            ...
            <div class="collapse navbar-collapse">
                    <div class="">
                        <ul class="nav navbar-nav navbar-left">
                            <li class="dropdown">
                                <a href="planos.php" class="nav nav-link cor2" id="nav" style="font-family:'Century Gothic';">
                                Planos de Internet
                                </a>
                            </li>
                            <!--<li class="dropdown">
                                <a href="boletos.php" class="nav nav-link cor2" id="nav" style="font-family:'Century Gothic';">
                                Gerar Boleto
                                </a>
                            </li>-->
                            <li class="dropdown">
                            <a href="cadastrarGeral.php" class="nav nav-link cor2" id="nav" style="font-family:'Century Gothic';">
                                Cadastrar Usuários
                            </a>
                            </li>
                            <li class="dropdown">
                            <a href="#gaia" class="dropdown-toggle nav nav-link cor2" data-toggle="dropdown" id="nav" style="font-family:'Century Gothic';">
                                Pesquisar
                            </a>
                            <ul class="dropdown-menu ">
                                <li>
                                    <a href="clientes.php" name="cliente" class="nav-link" style="font-family:'Century Gothic';">Pesquisar Usuários</a>
                                </li>
                                <li>
                                    <a href="ConsultaAssist.php" class="nav-link" id="nav" style="font-family:'Century Gothic';">
                                    Solicitações de A. Tecnica
                                    </a>
                                </li>
                            </ul>
                        </li>
