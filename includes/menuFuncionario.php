<nav class="navbar navbar-transparent navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="javascript:void(0);" class="navbar-brand hidden-xs hidden-sm" title="Inicial">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu ">
                                    <li>
                                        <a href="#" class="nav-link" style="font-family:'Century Gothic';">Pesquisar Cliente</a>
                                    </li>
                                    <li>
                                        <a href="#planos" class="nav-link" id="nav" style="font-family:'Century Gothic';">
                                        Ver Assistências Tecnica
                                        </a>
                                    </li>
                                </ul>
                            </li>
