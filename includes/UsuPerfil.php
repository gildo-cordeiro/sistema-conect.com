<div class="row">
    ...
    <div class="col-sm-12 col-md-4">
        <?php 
            ...
            for ($i=0; $i < $qtde_linhas; $i++) {
                echo "<li class='list-group-item' style='font-size:20px;'>";
                    if ($tabela[$i][4]!=""){
                        echo "<label style='font-size:10px;position:absolute;margin-top:-7px;'>CEP</label>";
                        echo $tabela[$i][4]; 
                    }else{
                         echo "\"CEP\"";
                    }
    ...
    <div class="col-sm-12 col-md-4">
        <?php 
            ...
            for ($i=0; $i < $qtde_linhas; $i++) {
                echo "<li class='list-group-item' style='font-size:20px;'>";
                    if ($tabela[$i][5]!=""){
                        echo "<label style='font-size:10px;position:absolute;margin-top:-7px;'>Estado</label>";
                        echo $tabela[$i][5]; 
                    }else{
                         echo "\"Estado\"";
                    }
    ...
    <div class="col-sm-12 col-md-4">
        <?php 
            ...
            for ($i=0; $i < $qtde_linhas; $i++) {
                echo "<li class='list-group-item' style='font-size:20px;'>";
                    if ($tabela[$i][6]!=""){
                        echo "<label style='font-size:10px;position:absolute;margin-top:-7px;'>Endereço</label>";
                        echo $tabela[$i][6]; 
                    }else{
                         echo "\"Endereço\"";
                    }
    ...
    <div class="col-sm-12 col-md-4">
        <?php 
            ...
            for ($i=0; $i < $qtde_linhas; $i++) {
                echo "<li class='list-group-item' style='font-size:20px;'>";
                    if ($tabela[$i][7]!=""){
                        echo "<label style='font-size:10px;position:absolute;margin-top:-7px;'>Cidade</label>";
                        echo $tabela[$i][7]; 
                    }else{
                         echo "\"Cidade\"";
                    }
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <button class="btn btn-primary" data-toggle="modal" data-target="#atualizar" style="font-size:15px;color: #ffffff;text-transform:capitalize;">Atualizar</button>
        </div>
    </div>
    <hr>
</div>