...
<BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
  <table width=666 cellspacing=0 cellpadding=0 border=0>
    <tr>
      <td valign=top class=cp><div ALIGN="CENTER">Instruções de Impressão</div>
    </td>
  </tr>
  <tr>
    <td valign=top class=cp><div ALIGN="left">
      <p>
        <li>Imprima em impressora jato de tinta (ink jet) ou laser em qualidade normal ou alta (Não use modo econômico).<br>
          <li>Utilize folha A4 (210 x 297 mm) ou Carta (216 x 279 mm) e margens mínimas é esquerda e a direita do formulário.<br>
            <li>Corte na linha indicada. Não rasure, risque, fure ou dobre a região onde se encontra o cópdigo de barras.<br>
              <li>Caso não apareça o código de barras no final, clique em F5 para atualizar esta tela.
                <li>Caso tenha problemas ao imprimir, copie a sequencia numerica abaixo e pague no caixa eletrônico ou no internet banking:<br><br>
                  <span class="ld2">
                    &nbsp;&nbsp;&nbsp;&nbsp;Linha Digitavel: &nbsp; '.$dadosboleto["linha_digitavel"].'<br>
         ...
         <table cellspacing=0 cellpadding=0 width=666>
          <tr>
            ...
            </td><td class=cpt width=58 valign=bottom>
              <div align=center><font class=bc> '.$dadosboleto["codigo_banco_com_dv"].'</font></div></td><td width=3 valign=bottom><img height=22 src=img/3.png width=2 border=0></td><td class=ld align=right width=453 valign=bottom><span class=ld> 
          ...
          <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
              <tr>
                ...
                <td class=ct valign=top width=7 height=13>
                  <img height=13 src=img/1.png width=1 border=0></td>
                ...
                <tr>
                  ...
                  <td class=cp valign=top width=7 height=12>
                    <img height=12 src=img/1.png width=1 border=0></td>
                  ...
                  <tr>
                    ...
                    <td valign=top width=34 height=1>
                      <img height=1 src=img/2.png width=34 border=0></td>
                      <td valign=top width=7 height=1>
                        <img height=1 src=img/2.png width=7 border=0>
                      </td>
                  ...
                  <table cellspacing=0 cellpadding=0 border=0>
                    <tbody>
                      <tr>
                        ...
                        <td class=ct valign=top width=180 height=13>(=) Taxa do Boleto</td>
                      </tr>
                      <tr>
                        <td class=cp valign=top width=7 height=12>
                          <img height=12 src=img/1.png width=1 border=0>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <tr>
                          ...
                          <td valign=top width=659 height=1>
                            <img height=1 src=img/2.png width=659 border=0></td>
                          </tr>
                        </tbody>
                      </table>
                      <table cellspacing=0 cellpadding=0 border=0>
                        <tbody>
                          <tr>
                            ...
                            <td class=ct  width=564 ></td>
                            <td class=ct  width=7 height=12></td>
                            <td class=ct  width=88 >Autenticção mecânica</td>
                          </tr>
                        </tbody>
                      </table>
                      <table cellspacing=0 cellpadding=0 width=666 border=0>
                      ...
                      <table cellspacing=0 cellpadding=0 width=666 border=0>
                        <tr>
                          <td class=cp width=150> 
                            <span class="campo">
                              <img src="img/logobradesco.jpg" width="150" height="40" border=0>
                            </span>
                          </td>
                          <td width=3 valign=bottom>
                            <img height=22 src=img/3.png width=2 border=0>
                      ...
                      <table cellspacing=0 cellpadding=0 border=0>
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class=cp valign=top width=472 height=12>Pagavel em qualquer Banco até o vencimento</td>
                            <td class=cp valign=top width=7 height=12>
                              <img height=12 src=img/1.png width=1 border=0>
                            </td>
                            <td class=cp valign=top align=right width=180 height=12> 
                      ...
                      <table cellspacing=0 cellpadding=0 border=0>
                        <tbody>
                          <tr>
                            ...
                            <td class=ct valign=top width=82 height=13>Data proce.:</td>
                            <td class=ct valign=top width=7 height=13>
                              <img height=13 src=img/1.png width=1 border=0>
                            </td>
                       ...
                       <td class=cp valign=top width=7 height=12>
                        <img height=12 src=img/1.png width=1 border=0>
                      </td><td class=cp valign=top align=right width=180 height=12> 
                       <span class="campo">
                          '.$dadosboleto["nosso_numero"].'
                       </span>
                     </td>
        ...
        <table cellspacing=0 cellpadding=0 width=666 border=0>
          <tbody>
            <tr>
              <td align=right width=9>
                <table cellspacing=0 cellpadding=0 border=0 align=left>
                  <tbody> 
                    ...
                    <tr> 
                      <td class=cp valign=top width=10 height=12>
                        <img height=12 src=img/1.png width=1 border=0>
                      </td>
                    </tr>
                    <tr> 
                      <td valign=top width=2 height=1>
                        <img height=1 src=img/2.png width=>
                      </td>
              ...
              <td valign=top width=465 rowspan=5>
              ...
              <tr>
                <td align=right width=10> 
                  <table cellspacing=0 cellpadding=0 border=0 align=left>
                    <tbody>
                      <tr>
                        <td class=ct valign=top width=10 height=13>
                          <img height=13 src=img/1.png width=1 border=0>
                        </td>
                      </tr>
                      <tr>
                  ...
                  <table cellspacing=0 cellpadding=0 border=0>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td valign=top width=180 height=1>
                          <img height=1 src=img/2.png width=180 border=0></td>
                        </tr>
                      </tbody>
                    </table>
                  </td>
                    ...
                    <table cellspacing=0 cellpadding=0 border=0>
                      <tbody>
                        <tr> 
                          ...
                          <td class=ct valign=top width=180 height=13>(+) Outros acrescimos</td>
                        </tr>
                        <tr> 
                          <td class=cp valign=top width=7 height=12>
                            <img height=12 src=img/1.png width=1 border=0>
          ...
          <table cellSpacing=0 cellPadding=0 width=666 border=0>
            <tbody>
              <tr>
                <td Align=bottom align=left><img  height=30px width=100 src=img/barra.png> 
                <img  height=30px width=100 src=img/barra.png border=0> 
                <img  height=30px width=100 src=img/barra.png border=0> 
                <img  height=30px width=100 src=img/barra.png border=0>  
              </td>
            </tr>
